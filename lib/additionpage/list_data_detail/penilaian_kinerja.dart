...
import 'package:pelaport/additionpage/list_data_detail/penilaian_kinerja_detail.dart';
...
class PenilaianKinerja extends StatefulWidget {
  const PenilaianKinerja({Key? key}) : super(key: key);

  @override
  _PenilaianKinerjaState createState() => _PenilaianKinerjaState();
}

class _PenilaianKinerjaState extends State<PenilaianKinerja> {
  String _nik = '';
